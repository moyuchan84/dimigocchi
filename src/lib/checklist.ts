...
export const CHECKLIST_STAGES: readonly ChecklistStage[] = [
	...
	},
	{
		...
		items: [
			...
			{ id: 'summer-4', label: '입학설명회·학교투어·학과체험교실 참가 신청하기', tentative: true },
		],
	},
	{
		id: 'before-apply',
		...
		items: [
			{ id: 'before-apply-1', label: '확정 전형요항에서 제출 서류와 마감 시각 다시 확인하기', tentative: true },
			...
			{ id: 'before-apply-5', label: '원서 접수 기간·방법 달력에 표시하기', tentative: true },
		],
	},
	{
		id: 'before-interview',
		...
		items: [
			...
			{ id: 'before-interview-4', label: '면접 일시·장소·준비물 확인하기', tentative: true },
		],
	},
] as const;
